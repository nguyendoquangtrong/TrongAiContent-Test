...
const KHOI_Y_TUONG_TU_XU_HUONG = [
  '',
  'KHI DU LIEU CO CHUA tinHieuXuHuong (chu de va cong thuc ke cua kenh theo doi):',
  '- Hoc CONG THUC KE (kieu hook, do dai, cach tiep can) va CHU DE de ap dung vao san pham/thuong hieu.',
  '- TUYET DOI KHONG sao chep; phai dung giong thuong hieu va thong tin san pham trong ho so.',
  '- Y tuong hoc tu tin hieu nao thi ghi ro trong lyDoDeXuat (kem ma/tieu de tin hieu da hoc hoi).',
].join('\n');
