...
const LOI_NHAC = {
  ...
  'viet-bai': {
    ...
    loiNhac: [
      'Viet mot bai dang hoan chinh cho mang xa hoi dua tren y tuong, san pham va chan dung duoc cung cap.',
      'Mo dau bang cau hook cuon hut trong 1-2 dong dau. Bo cuc ro rang, xuong dong tach y de doc.',
      'Chi su dung DUNG MOT loi keu goi hanh dong (CTA) phu hop o cuoi bai.',
      'Kem theo 3-5 hashtag ngan gon, sat voi chu de bai viet.',
      'Neu du lieu co truong `epDoDai` (so): day la RANG BUOC SO TU BAT BUOC, phai viet dung so tu do.',
      'Neu du lieu co truong `mach` (mang chuoi): day la CAC BAI TRUOC trong cung mot chuoi bai, bai nay PHAI NOI TIEP mach chuyen va KHONG LAP LAI y cua bai truoc.',
      CHUNG,
  ...
  'viet-kich-ban': {
    ...
    loiNhac: [
      'Viet kich ban quay video ngan (Reels, TikTok, Shorts) tu y tuong hoac noi dung duoc cung cap.',
      'Cau truc video: Hook 1-3s -> Van de -> Trinh dien san pham/giai phap -> Ket qua/bang chung -> CTA.',
      'Chia thanh 3 den 6 phan canh ro rang.',
      'Moi phan canh gom:',
      '- "thoiLuongGiay": so giay uoc tinh cho canh (tong video tu 15 den 60 giay)',
      '- "hinhAnh": huong dan quay, goc may, hanh dong cua nhan vat hoac chu hien thi tren man hinh',
      '- "loiThoai": loi noi/voiceover tu nhien, noi duoc thanh tieng, ngan gon',
      CHUNG,
  ...
  'de-xuat-y-tuong': {
    ...
    loiNhac: [
      'De xuat danh sach y tuong noi dung phu hop cho thuong hieu dua tren ho so, san pham, chan dung, tru cot va insight.',
      'RANG BUOC BAT BUOC:',
      '- Moi y tuong phai NEO vao mot `truCot` va mot `chanDung` CO THAT trong du lieu nguoi dung. Khong tu bia ten moi.',
      '- `kham_pha`: dat true cho cac y tuong do duong, thuoc tuyen noi dung moi hoac chua co du lieu; dat false cho tuyen cot loi da co du lieu.',
      '- `gocTiepCan`: goc nhin hoac cach khai thac chu de doc dao, thiet thuc cho nguoi doc.',
      '- `cauMoDau`: cau hook gay chu y phu hop voi be mat duoc chon.',
      '- `lyDoDeXuat`: giai thich ngan vi sao y tuong nay phu hop voi doi tuong va kenh dang.',
      '- `beMat`: chon dung mot trong: "fanpage", "ho_so_ca_nhan", "tiktok", "zalo".',
      CHUNG,
